...
WITH mercury_benchmark AS (
  -- Mercury found these high-dwell packages
  SELECT * FROM (VALUES
    ('TBA324382452417', '2025-09-15 03:23:48', 2269),
    ('TBA324407564226', '2025-09-16 02:32:04', 267),
    ('TBA324387931890', '2025-09-15 10:59:49', 289),
    ('TBA324328209818', '2025-09-12 18:18:32', 2497),
    ('TBA324408440124', '2025-09-16 05:02:36', 266)
  ) AS t(tracking_id, induct_time, mercury_dwell_min)
),
